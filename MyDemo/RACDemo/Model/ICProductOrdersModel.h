...
@property (nonatomic, copy, readonly) NSAttributedString *amount;       ///< 总价
@property (nonatomic, copy, readonly) NSAttributedString *offAmount;    ///< 优惠额度
@property (nonatomic, copy, readonly) NSString *showPrice;              ///< 单价
